      ...
      <section style={{ minHeight: "auto", display: "flex", alignItems: "center", justifyContent: "center", padding: "clamp(80px, 15vw, 120px) clamp(20px, 5vw, 40px) clamp(60px, 10vw, 80px)", position: "relative", overflow: "hidden", marginTop: 0 }}>
        <div style={{ maxWidth: "min(100%, 1200px)", margin: "0 auto", position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
          ...
          <div style={{ width: "100%", maxWidth: 900, marginBottom: 80, borderRadius: 12, overflow: "hidden", boxShadow: "0 8px 32px rgba(255, 215, 0, 0.15)" }}>
            <div dangerouslySetInnerHTML={{__html: `<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1199173148?h=a85260fd78&badge=0&autopause=0&player_id=0&app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Video_JLS"></iframe></div><script src="https://player.vimeo.com/api/player.js"><\/script>`}} />
          </div>
        </div>
      </section>
                  ...
                  {item.type === "video" ? (
                    <>
                      <div style={{ position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden", background: "var(--card)" }}>
                        <iframe
                          src={`https://player.vimeo.com/video/${item.id}?h=${item.hash}&badge=0&autopause=0&player_id=0&app_id=58479&rel=0`}
